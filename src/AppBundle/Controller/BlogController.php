...
class BlogController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('blog_show', array('idBlog' => $blog->getIdblog()));
        }
     ...
     *
     * @Route("/{idBlog}/edit", name="blog_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Blog $blog)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('blog_edit', array('idBlog' => $blog->getIdblog()));
        }
    ...
    private function createDeleteForm(Blog $blog)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('blog_delete', array('idBlog' => $blog->getIdblog())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
